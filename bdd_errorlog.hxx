...
#define BDD_LOG_ERROR3(Msg, Param1, Param2, Param3) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1, Param2, Param3)
#define BDD_LOG_ERROR4(Msg, Param1, Param2, Param3, Param4) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1, Param2, Param3, Param4)
#define BDD_LOG_ERROR5(Msg, Param1, Param2, Param3, Param4, Param5) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1, Param2, Param3, Param4, Param5)
...
#define BDD_LOG_WARNING3(Msg, Param1, Param2, Param3) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_WARNING_LEVEL, Msg, Param1, Param2, Param3)
#define BDD_LOG_WARNING4(Msg, Param1, Param2, Param3, Param4) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_WARNING_LEVEL, Msg, Param1, Param2, Param3, Param4)
#define BDD_LOG_WARNING5(Msg, Param1, Param2, Param3, Param4, Param5) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_WARNING_LEVEL, Msg, Param1, Param2, Param3, Param4, Param5)
...
#define BDD_LOG_EVENT3(Msg, Param1, Param2, Param3) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_TRACE_LEVEL, Msg, Param1, Param2, Param3)
#define BDD_LOG_EVENT4(Msg, Param1, Param2, Param3, Param4) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_TRACE_LEVEL, Msg, Param1, Param2, Param3, Param4)
#define BDD_LOG_EVENT5(Msg, Param1, Param2, Param3, Param4, Param5) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_TRACE_LEVEL, Msg, Param1, Param2, Param3, Param4, Param5)
...
#define BDD_LOG_INFORMATION3(Msg, Param1, Param2, Param3) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, Msg, Param1, Param2, Param3)
#define BDD_LOG_INFORMATION4(Msg, Param1, Param2, Param3, Param4) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, Msg, Param1, Param2, Param3, Param4)
#define BDD_LOG_INFORMATION5(Msg, Param1, Param2, Param3, Param4, Param5) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, Msg, Param1, Param2, Param3, Param4, Param5)
...
#define BDD_LOG_LOW_RESOURCE2(Msg, Param1, Param2) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_WARNING_LEVEL, Msg, Param1, Param2)
...
#define BDD_LOG_ASSERTION0(Msg) \
    do { \
        DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg); \
        NT_ASSERT(FALSE); \
    } while (0)
#define BDD_LOG_ASSERTION1(Msg, Param1) \
    do { \
        DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1); \
        NT_ASSERT(FALSE); \
    } while (0)
#define BDD_LOG_ASSERTION2(Msg, Param1, Param2) \
    do { \
        DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1, Param2); \
        NT_ASSERT(FALSE); \
    } while (0)
#define BDD_LOG_ASSERTION3(Msg, Param1, Param2, Param3) \
    do { \
        DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1, Param2, Param3); \
        NT_ASSERT(FALSE); \
    } while (0)
#define BDD_LOG_ASSERTION4(Msg, Param1, Param2, Param3, Param4) \
    do { \
        DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1, Param2, Param3, Param4); \
        NT_ASSERT(FALSE); \
    } while (0)
#define BDD_LOG_ASSERTION5(Msg, Param1, Param2, Param3, Param4, Param5) \
    do { \
        DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_ERROR_LEVEL, Msg, Param1, Param2, Param3, Param4, Param5); \
        NT_ASSERT(FALSE); \
    } while (0)
